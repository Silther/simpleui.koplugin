            ...
            },
            {
                ...
                sub_item_table_func = function()
                    return {
                        ...
                        -- "Custom Tabs" groups the settings for each
                        -- custom-tab plugin that slots into SimpleUI's
                        -- navbar.  Right now only BookFusion lives here;
                        -- future custom tabs can be added alongside it.
                        -- Each tab's builder is pcall-wrapped so a syntax
                        -- error in one can't knock out the whole Simple
                        -- UI settings menu.
                        {
                            text = _("Custom Tabs"),
